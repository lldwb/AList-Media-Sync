 ...
 * <p>
 * 使用 {@link WireMockTest} 启动 WireMock 服务器，模拟 AList API 行为。
...
class AListStorageStrategyIT {
    ...
    void testConnectionShouldReturnFalseWhenPingFails() {
        stubFor(get("/ping").willReturn(serverError()));
    ...
    void downloadFileShouldReturnInputStream() throws Exception {
        ...
        // raw_url 下载端点
        stubFor(get("/download/e2e-test/test.mp4")
