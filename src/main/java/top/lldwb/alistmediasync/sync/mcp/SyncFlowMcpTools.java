...
public class SyncFlowMcpTools {
    ...
    public McpSchema.CallToolResult syncFlowCreateAndExecute(
        ...
        return result.run("sync_flow_create_and_execute", () -> {
            ...
            if (targetFormat != null) dto.setTargetFormat(SyncTask.TargetFormat.valueOf(targetFormat));
            if (conflictStrategy != null) dto.setConflictStrategy(SyncTask.ConflictStrategy.valueOf(conflictStrategy));
